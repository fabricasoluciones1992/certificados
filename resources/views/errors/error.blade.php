<html lang="en"><head>
    <meta charset="UTF-8">
      ...
      <link rel="apple-touch-icon" type="image/png" href="{{ asset('img/logoicono.png') }}">

      <meta name="apple-mobile-web-app-title" content="CodePen">

      <link rel="shortcut icon" type="image/x-icon" href="{{ asset('img/logoicono.png') }}">

      <link rel="mask-icon" type="image/x-icon" href="{{ asset('img/logoicono.png') }}" color="#111">
